...
class PhongShading
{
 public:
   ...
   // setter
   void SetInitCamera(Position pos);
   void SetInitLightColor(RGBSpace color, DirectionVector dir);
   void SetInitObject(RGBSpace color, float ka, float kd, float ks, float kp);
